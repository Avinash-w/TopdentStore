					...
					<div className=" w-full sm:w-1/2 mx-auto h-full flex flex-col justify-center gap-2 bg-blue-100  rounded-lg shadow-lg p-5">
						<div className="flex gap-3">
							...
							<div className="flex flex-col text-slate-900">
								<span className="font-bold text-red-500 text-4xl italic">Top Dent</span>
						...
						<Link to="/about" className=" text-center bg-red-500 hover:bg-white hover:text-red-500 font-bold text-white rounded p-2 transition">
							Know More
						</Link>
					</div>
				</div>
