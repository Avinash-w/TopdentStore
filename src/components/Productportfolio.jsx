      ...
      >
        ...
        <SwiperSlide>
          <div
            ...
            style={{ backgroundImage: "url('./src/assets/images/home-1.webp')" }}
          ></div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div
            className="h-96 bg-cover bg-center rounded-lg shadow-lg"
            style={{ backgroundImage: "url('./src/assets/images/home-2.webp')" }}
          ></div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div
            className="h-96 bg-cover bg-center rounded-lg shadow-lg"
            style={{ backgroundImage: "url('./src/assets/images/home-3.webp')" }}
          ></div>
        </SwiperSlide>
      </Swiper>
    </div>
