const Topbrands = () => {
	return (
		<div>
			<div className="bg-blue-100 py-6 px-6 rounded-2xl mx-auto  w-full shadow-sm  sm:grid sm:grid-cols-2 md:grid-cols-4 items-center justify-between gap-10">
				{/* 20,000+ Products */}
				<div className="flex items-center gap-2 text-gray-700">
					...
					<span className="font-semibold text-lg text-red-500   sm:text-lg md:text-2xl">100% Customer Satisfaction</span>
				</div>
				...
				<div className="flex items-center gap-2 text-gray-700">
					...
					<span className="font-semibold text-lg text-red-500   sm:text-lg md:text-2xl">100% Original</span>
				</div>
				...
				<div className="flex items-center gap-2 text-gray-700">
					...
					<span className="font-semibold text-lg text-red-500   sm:text-lg md:text-2xl">Affordable price</span>
				</div>
				{/* 450+ Brands */}
				<div className="flex items-center gap-2 text-gray-700">
					...
					<span className="font-semibold text-lg text-red-500   sm:text-lg md:text-2xl   ">
